...
from SR_ARsquare_V3 import CalculateShapeFactorFromImage
import matplotlib.pyplot as plt
...
for fichier in fichiers:
    percent = 0.0001
    S = S + [CalculateShapeFactorFromImage(fichier, percent,10)]
...
percent = 0.0003
CalculateShapeFactorFromImage(image_path, percent,10)
